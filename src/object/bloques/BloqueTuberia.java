...
public class BloqueTuberia extends GameObjeto {

    public BloqueTuberia(int x, int y, int width, int height, int xDesplasamiento) {
...
//        g.drawRect((int) getX(), (int) getY(), (int) (getX() + getWidth()), (int) (getY() + getHeight()), Color.RED);
    ...
    public GameObjeto clone() {
        return new BloqueTuberia((int) x, (int) y, (int) width, (int) height, (int) xDesplasamiento);
    }
}
